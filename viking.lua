...
local N = (Redis:get(viking.."Name:Bot") or "ريبورتر")
...
--download('https://raw.githubusercontent.com/yaknti172/yaknti17/master/viking.lua','viking.lua')
...
LuaTele.sendText(msg_chat_id,msg_id,'*⌔︙عدد احصائيات البوت الكامله \n┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉ ┉\n⌔︙عدد المجموعات : '..(Redis:scard(viking..'viking:ChekBotAdd') or 0)..'\n⌔︙عدد المشتركين : '..(Redis:scard(viking..'viking:Num:User:Pv') or 0)..'*',"md",true)  
end
...
{
{text = '•𝙗𝙤𝙩 𝙨𝙚𝙯𝙧•',url="t.me/viking8Bot"}
},
}
local msg_id = msg.id/2097152/0.5 
 https.request("https://api.telegram.org/bot"..Token..'/sendPhoto?chat_id='..msg.chat_id..'&caption='..URL.escape(TestText)..'&photo='..photo.photos[1].sizes[#photo.photos[1].sizes].photo.remote.id..'&reply_to_message_id='..msg_id..'&parse_mode=markdown&disable_web_page_preview=true&reply_markup='..JSON.encode(keyboardd))
...
local Mostafa = (Redis:get(viking.."Name:Bot") or "ريبورتر")
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
local RinkBot = msg.Name_Controller
photo = "https://t.me/V_I_K_I_N_G_2/142"
...
{
{text = '•ʙᴏᴛ•', url = "https://t.me/hazf_viking_bot"}
},
{
{text = '•اضف البوت لمجموعتك•', url = 't.me/'..UserBot..'?startgroup=new'},
},
...
local NamesBot = (Redis:get(viking.."viking:Name:Bot") or "ريبورتر")
local BotName = {
...
if text == (Redis:get(viking.."viking:Name:Bot") or "ريبورتر") then
local photo = LuaTele.getUserProfilePhotos(viking)
local UserInfo = LuaTele.getUser(viking)
local user_info = LuaTele.getUser(msg.sender.user_id)
local first_name = user_info.first_name
...
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تعط','تعطيل الايدي بالصوره')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تفع','تفعيل الايدي بالصوره')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ا','ايدي')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'م','رفع مميز')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اد', 'رفع ادمن')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مد','رفع مدير')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'من', 'رفع منشئ')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'اس', 'رفع منشئ اساسي')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'مط','رفع مطور')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'تك','تنزيل الكل')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ر','الرابط')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رر','الردود')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'،،','مسح المكتومين')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رد','اضف رد')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'سح','مسح سحكاتي')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'غ','غنيلي')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'رس','رسائلي')
Redis:set(viking.."Get:Reides:Commands:Group"..msg_chat_id..":"..'ثانوي','رفع مطور ثانوي')
...
Redis:set(viking.."Redis:Id:Group"..msg_chat_id,band)
...
{
{text = '•ʙᴇɴᴛ ᴛɪᴍᴏ¹•', url = "https://t.me/bent_viking"}
},
{
{text = '•ʙᴇɴᴛ ᴛɪᴍᴏ²•', url = "https://t.me/bent_ti_mo"},{text = '•ʙᴇɴᴛ ᴛɪᴍᴏ³•', url = "https://t.me/bent_dad_viking"}
},
{
{text = '•ʙᴏᴛ ᴛᴇᴀᴍ•', url = "https://t.me/viking8BOT"}
},
{
